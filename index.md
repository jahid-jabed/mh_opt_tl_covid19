...
+ **Sample Data:** Following is the sample of dataset with class label. <br> ![Sample Dataset](https://raw.githubusercontent.com/jahid-jabed/mh_opt_tl_covid19/main/Pictures/Sample_Data.png "Sample Dataset")
...
**D. Codes**
+ **Model: **
  - `VGG16`: VGG16 model primirily used for this project. Following figure show the structure of this CNN model. <br> ![VGG16](https://raw.githubusercontent.com/jahid-jabed/mh_opt_tl_covid19/main/Pictures/VGG16_CNN.png "VGG16")
...
**E. Results and Performance**
  - **Results:** Performance of the Transfer Learning Models with and without Genetic Optimization. <br> ![Results](https://raw.githubusercontent.com/jahid-jabed/mh_opt_tl_covid19/main/Pictures/Results.PNG "Results")
